...
@section('container')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Input Data Layanan</h1>
        <p class="mb-4">Halaman ini digunakan input data oleh admin, tabel ini hanya bisa dilihat oleh admin</p>
                                ...
                                <div class="row">
                                    @foreach ($tables as $table)
                                        <div class="col-md-4 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <a href="/dashboardadmin/services/{{ $table->slug }}">
